                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($movimiento_contenedor as $key => $fila): ?>
                                        <tr>
                                            ...
                                            <td style="text-align:center"><?php echo substr($fila->FECHA_FLAG_MOVIMIENTO, 0, 10); ?></td>
                                            <td style="text-align:center"><?php echo substr($fila->FECHA_FLAG_MOVIMIENTO,11) ; ?></td>                 
