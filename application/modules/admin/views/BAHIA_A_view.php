 ...
 <script type="text/javascript">
       function informacion(){
            $.ajax({
                type: "post", 
                url: "<?= site_url('admin/BAHIA_A1/informacion_bahia_A1') ?>",
                dataType: "json",
  ...
  <div class="sub-nav hidden-sm hidden-xs">
    <ul>
        <li><a href="#" class="heading">  BAHIA A1</a></li>
    </ul>
...
function exito(data) {
    ...
    for (var i = data.length-1; i >= 0; i--){
     ...
     $.ajax({
           ...
           url: "<?= site_url('admin/Bahia_A1/maestro_bahia_A1') ?>",
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="#" id="form_color" >

          <!--<input type="hidden" value=""  placeholder="fk_card" name="fk_card"/>  -->
          
  <!--         <div >
            <label for="recipient-name" class="col-form-label">BL-MASTER DE CONTENEDOR</label>
            <input type="text" class="form-control" id="bl_master" name="bl_master" placeholder="Ingresar el código del contenedor">
          </div>
      ...
      <div class="modal-footer">
        <button type="button" id="btnSave" class="btn btn-secondary"   data-dismiss="modal">Cerrar</button>
        <button type="button" class="btn btn-primary" onclick="save()" >Buscar</button>
      </div>
    </div>
  </div>
</div>-->
