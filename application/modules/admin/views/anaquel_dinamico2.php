                                ...
                                <table id='tabla_fondo'>   
                                    ...
                                    <TR> 
                                        <?php foreach ($carga as $key => $value): ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '2_D(1)'): ?>
                                                <TD>

                                                    <?php
                                                    if (($value->ESTADO_CUERPOS) == "OCUPADO") {
                                                        ?>
                                                        <img src="<?php echo base_url(); ?>img/anaquel12_lleno.jpg">  
                                            ...
                                            <?PHP endif; ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '2_D(2)'): ?>
                                                <TD> 
                                                    <?php
                                                    if (($value->ESTADO_CUERPOS) == "OCUPADO") {
                                                        ?>
                            ...
                            <div class="col-lg-3 col-md-3">
                                ...
                                <table id='tabla_fondo'>   
                                    <center><a id="delay" class="btn btn-warning" href="#" data-original-title="" title="" style=""> Cuerpo 03 - 04 </a></center> <br>
                                      <TR> 
                                        <?php foreach ($carga as $key => $value): ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '2_D(3)'): ?>
                                                <TD>
                                            ...
                                            <?PHP endif; ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '2_D(4)'): ?>
                                                <TD> 
                                                    <?php
                                                    if (($value->ESTADO_CUERPOS) == "OCUPADO") {
                                                        ?>
...
<TR> 
                                        <?php foreach ($carga as $key => $value): ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '2_D(5)'): ?>
                                                <TD>
                                            ...
                                            <?PHP endif; ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '2_D(6)'): ?>
                                                <TD> 
                                                    <?php
                                                    if (($value->ESTADO_CUERPOS) == "OCUPADO") {
                                                        ?>
                            ...
                            <div class="col-lg-3 col-md-3">
                                ...
                                <table id='tabla_fondo'>   
                                    ...
                                    <TR> 
                                        <?php foreach ($carga as $key => $value): ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '2_D(7)'): ?>
                                                <TD>
                                            ...
                                            <?PHP endif; ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '2_D(8)'): ?>
                                                <TD> 
                                                    <?php
                                                    if (($value->ESTADO_CUERPOS) == "OCUPADO") {
                                                        ?>
                                ...
                                <table id='tabla_fondo'>   
                                    ...
                                    <TR> 
                                        <?php foreach ($carga as $key => $value): ?>
                                            ...
                                            <?PHP endif; ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '2_D(9)'): ?>
                                                <TD> 
                                                    <?php
                                                    if (($value->ESTADO_CUERPOS) == "OCUPADO") {
                                                        ?>
...
<TR> 
                                        <?php foreach ($carga as $key => $value): ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '2_D(11)'): ?>
                                                <TD>
                                            ...
                                            <?PHP endif; ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '2_D(12)'): ?>
                                                <TD> 
                                                    <?php
                                                    if (($value->ESTADO_CUERPOS) == "OCUPADO") {
                                                        ?>
                            ...
                            <div class="col-lg-3 col-md-3">
                                ...
                                <table id='tabla_fondo'>   
                                    ...
                                    <TR> 
                                        <?php foreach ($carga as $key => $value): ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '2_D(13)'): ?>
                                                <TD>
                                            ...
                                            <?PHP endif; ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '2_D(14)'): ?>
                                                <TD> 
                                                    <?php
                                                    if (($value->ESTADO_CUERPOS) == "OCUPADO") {
                                                        ?>
