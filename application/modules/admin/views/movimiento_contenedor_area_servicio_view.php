...
<script>
    ...
    $("#div1").load("<?php echo base_url(); ?>admin/movimiento_contenedores_area_servicio/movimiento_area");
    }, 500);
...
<div class="sub-nav hidden-sm hidden-xs">
    <ul>
        <li><a href="#" class="heading">Movimiento de Contenedor en Area de Servicio</a></li>
    </ul>
                    ...
                    <div class="list-group no-margin">
                        <span id="mymodal" data-toggle="modal" data-target="#myModal">  
                            <a href="javascript:;" class="list-group-item">
                                ...
                                <p class="list-group-item-text">Movimiento de Contenedores</p>
                                <br>
                            </a>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="widget">
                    <div class="widget-header">
                        <div class="title">
                            Movimiento de Contenedor en Area de Servicio
                        </div>
                        <span class="tools">
                        ...
                        <div class="modal-dialog1" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel" >MOVIMIENTO DE CONTENEDOR EN ÁREA DE SERVICIO</h4>
                                </div>
