<div class="row">
                                ...
                                <table id='tabla_fondo'>   
                                    ...
                                    <TR style="text-align:center" > 
                                        <?php foreach ($carga as $key => $value): ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '7_D(1)'): ?>
                                                <TD>
                                                    <?php
                                            ...
                                            <?PHP endif; ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '7_D(2)'): ?>
                                                <TD> 
                            ...
                            <div class="col-lg-3 col-md-3">
                                ...
                                <table id='tabla_fondo'>   
                                    ...
                                    <TR style="text-align:center" > 
                                        <?php foreach ($carga as $key => $value): ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '7_D(3)'): ?>
                                                <TD>
                                                    <?php
                                                    if (($value->ESTADO_CUERPOS) == "OCUPADO") {
                                                        ?>
                                            ...
                                            <?PHP endif; ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '7_D(4)'): ?>
                                                <TD> 
                            ...
                            <div class="col-lg-3 col-md-3">
                                ...
                                <table id='tabla_fondo'>   
                                    ...
                                    <TR style="text-align:center" > 
                                        <?php foreach ($carga as $key => $value): ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '7_D(5)'): ?>
                                                <TD>
                                                    <?php
                                                    if (($value->ESTADO_CUERPOS) == "OCUPADO") {
                                                        ?>
                                            ...
                                            <?PHP endif; ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '7_D(6)'): ?>
                                                <TD> 
                            ...
                            <div class="col-lg-3 col-md-3">
                                ...
                                <table id='tabla_fondo'>   
                                    ...
                                    <TR style="text-align:center" > 
                                        <?php foreach ($carga as $key => $value): ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '7_D(7)'): ?>
                                                <TD>
                                                    <?php
                                                    if (($value->ESTADO_CUERPOS) == "OCUPADO") {
                                                        ?>
                                            ...
                                            <?PHP endif; ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '7_D(8)'): ?>
                                                <TD> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3">
                                ...
                                <table id='tabla_fondo'>   
                                    ...
                                    <TR style="text-align:center" > 
                                        <?php foreach ($carga as $key => $value): ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '7_D(9)'): ?>
                                                <TD>
                                                    <?php
                                                    if (($value->ESTADO_CUERPOS) == "OCUPADO") {
                                                        ?>
                                            ...
                                            <?PHP endif; ?>
                                            <?PHP IF (($value->COD_SUB_CUERPOS) == '7_D(10)'): ?>
                                                <TD> 
                            ...
                            <div class="col-lg-3 col-md-3">
                                ...
                                <table id='tabla_fondo'>   
                                    ...
                                    <?php foreach ($carga as $key => $value): ?>
                                        <?PHP IF (($value->COD_SUB_CUERPOS) == '7_D(11)'): ?>
                                            <TD>
                                                <?php
                                                if (($value->ESTADO_CUERPOS) == "OCUPADO") {
                                                    ?>
                                        ...
                                        <?PHP endif; ?>
                                        <?PHP IF (($value->COD_SUB_CUERPOS) == '7_D(12)'): ?>
                                            <TD> 
